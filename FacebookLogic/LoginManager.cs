...
namespace FacebookLogic
{
    class LoginManager
    {
        private static readonly string sr_ErrorLoginMassage = "Error: Failed to login. Please try again";
        private static readonly string sr_ErrorInvalidAccessTokenMassage = "Error: Invalid access token. Please try different access token";
